    ...
    <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 p-0">
                        <h1 class=" mt-4 store-title t-secondary w-75">{{__('Order detail')}}</h1>
                        <div class="row mt-5">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="black-border"></div>
                                <ul class="banner-list">
                                    <a href="{{route('customer.home',$store->slug)}}" class="btn btn-sm btn-black btn-icon" >
                                        <span class="btn-inner--text text-white">{{__('Back to orders')}}</span>
