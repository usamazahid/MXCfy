                    ...
                    <div class="row">
                        ...
                        <div class="col-6 proprice">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('weight', null, ['class' => 'form-control','placeholder' => __('Enter Weight'),'required' => 'required'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/nr6grat3/saas.mxclogistics.com/resources/views/product/create.blade.php ENDPATH**/ ?>