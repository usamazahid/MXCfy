                    ...
                    <div class="container mt-7">
                        ...
                        <div class="row">
                            <div class="pr-title mb-4">
                                <h3 class=" mt-4 store-title t-secondary"><?php echo e(__('My Cart')); ?></h3>
    ...
    <div class="modal-dialog modal-md rounded-pill " >
      <div class="modal-content ">
        ...
        <div class="modal-body row">
            ...
            <div class="form-group col-6 d-flex justify-content-center col-form-label mb-0">
                <a href="<?php echo e(route('user-address.useraddress',$store->slug)); ?>" class="btn btn-yellow ms-2 rounded-pill"><?php echo e(__('Countinue as guest')); ?></a>
            </div>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('storefront.layout.theme2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/nr6grat3/saas.mxclogistics.com/resources/views/storefront/theme2/cart.blade.php ENDPATH**/ ?>