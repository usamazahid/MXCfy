  ...
  <body class="<?php echo e($color); ?>">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          ...
          <ul class="navbar-nav align-items-right ms-auto mb-2 mb-lg-0">
              <li class="nav-item">
              <a class="btn btn-light ms-2 me-1" href="<?php echo e(route('login')); ?>">Sign In</a>
            </li>

            <?php if(App\Models\Utility::getValByName('signup_button') == 'on'): ?>
            <li class="nav-item">
              <a class="btn btn-red ms-2 me-1" href="<?php echo e(route('register')); ?>">Free Trial</a>
            </li>
            <?php endif; ?>
          </ul>
        </div>
    ...
    <header id="home" class="bg-primary">
      <div class="container">
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-sm-6">
            <img
              src="<?php echo e(asset('assets/images/front/header-mokeup.png')); ?>"
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block gradient-block">
      <div class="container">
        ...
        src="<?php echo e(asset('landing/images/sample-themes.png')); ?>"
        alt=""
    ...
    <section id="dashboard" class="how-it-works">
      <div class="container-fluid">
        ...
        <img style="border-radius: 15px;"
        src="<?php echo e(asset('assets/images/front/how-it-works.png')); ?>"
        alt=""
        class="img-fluid img-dashboard wow animate__fadeInUp mt-5"
        data-wow-delay="0.2s"
      />
...
<?php /**PATH /home/wqfccupd0b8g/public_html/mxcfy.com/resources/views/layouts/landing.blade.php ENDPATH**/ ?>