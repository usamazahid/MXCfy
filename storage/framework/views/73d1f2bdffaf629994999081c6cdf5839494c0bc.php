            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="pr-title mb-4">
                        <h3 class="mt-4 store-title t-secondary playfair"><?php echo e(__('Payment')); ?></h3>
                        ...
                        <?php if(isset($store_payments['is_paystack_enabled']) && $store_payments['is_paystack_enabled']=='on'): ?>
                            ...
                            <script>
                                ...
                                function payWithPaystack() {
                                    ...
                                    var order_id = '<?php echo e($order_id = str_pad(!empty($order->id) ? $order->id + 1 : 0 + 1, 4, "100", STR_PAD_LEFT)); ?>';
                                    ...
                                    var x = getpaidSetup({
                                        ...
                                        callback: function (response) {
                                            ...
                                            if (
                                                ...
                                                window.location.href = flutter_callback + '/<?php echo e($store->slug); ?>/' + txref + '/' + order_id;
                                            } else {
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-4 col-md-4 text-right">
                                            <img alt="Image placeholder" src="<?php echo e(asset('assets/img/Paymentwall.png')); ?>" width="100">
                                                        ...
                                                        <div class="media align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <?php
                                                                    $total_tax=0;
                                                                ?>
                                                                <small class="text-muted s-dim"><?php echo e($product['quantity']); ?> x <?php echo e(\App\Models\Utility::priceFormat($product['price'])); ?>
                                            ...
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <div class="text-limit lh-100">
                                                        ...
                                                        <input type="hidden" name="coupon" class="form-control hidden_coupon" data_id="<?php echo e($coupon_id); ?>" value="<?php echo e($coupon_price); ?>"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4 text-right">
                                            <span class="text-sm font-weight-bold t-black15 dicount_price"><?php echo e(!empty($discount_price)?$discount_price:'0.00'); ?></span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="shipping_price_add">
                                            <div class="row mt-2 pt-2 border-top">
                                                <div class="col-8 text-right pt-2">
                                                    <div class="media align-items-center">
                                                        <div class="media-body">
                                                            <div class="text-dark lh-100 text-sm"><?php echo e(__('Shipping Price')); ?> :</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-4 text-right"><span class="text-sm font-weight-bold t-black15 shipping_price" data-value="<?php echo e($shipping_price); ?>"><?php echo e(\App\Models\Utility::priceFormat(!empty($shipping_price)?$shipping_price:0)); ?></span></div>
                                            </div>
                                        </div>
                                <?php endif; ?>
                                ...
                                <!-- Final total -->
                                    <div class="row mt-2 pt-2 border-top" id="Subtotal">
                                        ...
                                        <div class="col-4 text-right final_total_price">
                                            <span class="text-sm font-weight-bold t-black15 total_price" data-value="<?php echo e($total+$shipping_price-$coupon_price); ?>"> <?php echo e(\App\Models\Utility::priceFormat(!empty($total)?$total+$shipping_price-$coupon_price:0)); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('storefront.layout.theme2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/nr6grat3/saas.mxclogistics.com/resources/views/storefront/theme2/payment.blade.php ENDPATH**/ ?>